...
# Load the CSV file
csv_file_path = 'results/sorted_model_results6.csv'  # Replace with the path to your CSV file
data = pd.read_csv(csv_file_path)

# Convert the CSV file to Excel
excel_file_path = 'sorted_model_results6.xlsx'  # Replace with the desired Excel file path
